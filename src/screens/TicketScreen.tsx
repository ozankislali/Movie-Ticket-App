      ...
      <View style={styles.ticketContainer}>
        ...
        <View style={styles.ticketFooter}>
          ...
          <View style={styles.ticketDateContainer}>
            ...
            <View style={styles.subtitleContainer}>
              <MaterialCommunityIcons name="clock" style={styles.clockIcon} />
              <Text style={styles.subtitle}>{ticketData?.time}</Text>
            </View>
          </View>
          <View style={styles.ticketSeatContainer}>
            <View style={styles.subtitleContainer}>
              <Text style={styles.subheading}>Salon</Text>
              <Text style={styles.subtitle}>02</Text>
            </View>
            <View style={styles.subtitleContainer}>
              <Text style={styles.subheading}>Sıra</Text>
              <Text style={styles.subtitle}>04</Text>
            </View>
            <View style={styles.subtitleContainer}>
              <Text style={styles.subheading}>Koltuk</Text>
